            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                                        ...
                                        <table id="simple-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <c:forEach var="index" begin="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <fmt:formatDate value="${studentListVo.studentVoList.get(index).birthday}" pattern="yyyy-MM-dd"/>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);"
                                                           onclick="onOperateClick(${studentListVo.studentVoList.get(index).id},
                                                                   '${pageContext.request.contextPath}/student/putScore.do')"
                                                        >录入</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);"
                                                           onclick="onOperateClick(${studentListVo.studentVoList.get(index).id},
                                                                   '${pageContext.request.contextPath}/student/ChooseSubject.do')"
                                                        >选课</a>
                                                    </td>
                        ...
                        <div id="modal-message" class="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                             aria-hidden="true" >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer no-margin-top">
                                        ...
                                        <button class="btn btn-sm btn-primary pull-right" onclick="onSureDeleteClick()">
                                            <i class="ace-icon fa fa-check"></i>
                                            确定
                                        </button>
                                    </div>

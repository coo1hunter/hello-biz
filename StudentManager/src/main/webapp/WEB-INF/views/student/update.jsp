                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/update.do" method="post"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="avatar">照片</label>

                                <div class="col-sm-9">
                                    <span class="profile-picture">
                                        <img data-pk="13" alt="Alex's Avatar" class="img-responsive" id="avatar" src="${studentParamVo.studentVo.picture}"/>
                                        <input type="hidden" name="picture" id="pic_hidden" value="${studentParamVo.studentVo.picture}"/>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="id" name="id" required="required" class="col-xs-10 col-sm-5"
                                           maxlength="20"
                                        value="${studentParamVo.studentVo.id}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="name" name="name" required="required" class="col-xs-10 col-sm-5"
                                           maxlength="20"
                                        value="${studentParamVo.studentVo.name}"/>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <label>
                                        <input name="sex" type="radio" class="ace" value="0"
                                                <c:if test="${studentParamVo.studentVo.sex == 0}">
                                                    checked="checked"
                                                </c:if>/>
                                    ...
                                    <label>
                                        <input name="sex" type="radio" class="ace" value="1"
                                            <c:if test="${studentParamVo.studentVo.sex == 1}">
                                                checked="checked"
                                            </c:if> />
                                    ...
                                    <div class=" input-group col-xs-10 col-sm-5">
                                        <input class="form-control date-picker"  required="required" name="birthday"
                                               ...
                                               data-date-format="yyyy-mm-dd"
                                                value="<fmt:formatDate value="${studentParamVo.studentVo.birthday}" pattern="yyyy-MM-dd"/>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class=" input-group col-xs-10 col-sm-5 ">
                                        <select class="form-control chosen-select" id="gradeId" name="gradeId" data-placeholder="请选择" required="required">
                                            <c:forEach var="grade" items="${studentParamVo.grades}">
                                                <option value="${grade.id}"
                                                    <c:if test="${studentParamVo.studentVo.gradeId == grade.id}">
                                                        selected="selected"
                                                    </c:if>
                                                ><c:out value="${grade.name}"/> </option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
    ...
    jQuery(function ($) {
        ...
        try {//ie8 throws some harmless exceptions, so let's catch'em
            ...
            $('#avatar').editable({
                ...
                url: function(params) {
                    // ***UPDATE AVATAR HERE*** //
                    var submit_url = '${pageContext.request.contextPath}/student/imageUpLoad.do';//please modify submit_url accordingly
                    var deferred = null;
                    var avatar = '#avatar';

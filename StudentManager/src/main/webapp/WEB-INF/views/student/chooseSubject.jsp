    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="${pageContext.request.contextPath}/student/saveChoosedSubject.do" method="post">
                            <input type="hidden" name="studentVo.id" value="${id}">
                                                    ...
                                                    <c:forEach var="index" begin="0" end="${subjectVoList.size()-1}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                <label class="pos-rel">
                                                                    <input type="checkbox" class="ace"
                                                                           name="scoreVos[${index}].checked">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </td>

                                                            <input type="hidden" name="scoreVos[${index}].subjectId"
                                                            ...
                                                            <td>
                                                                <c:out value="${subjectVoList.get(index).num}"/>
                                                            </td>
                                                        </tr>

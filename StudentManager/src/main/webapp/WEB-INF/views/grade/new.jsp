        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="save.do">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 班级名： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="name" id="form-field-1" placeholder="班级名" class="col-xs-10 col-sm-5" required="required"/>
                                </div>
                            </div>
